                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              margin: EdgeInsets.only(right: 41.0, top: 10.0),
...
margin: EdgeInsets.all(20.0),
          child: Column(
            children: <Widget>[
              ListTile(
                title: Text("Account Info" , style: TextStyle(fontSize: 20.0 , fontWeight: FontWeight.w500),),
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder:(context)=>UserGetProfile()));
                },
              ),
